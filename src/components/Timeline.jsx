...
const Timeline = () => {
    ...
    return (
        <div className='flex'>
            <SideBarAgency />
            <div>
                <div className='font-bold text-xl text-gray-400 m-10'>Search by Date or Name</div>
                <div className='flex'>
                ...
                <div className='font-bold text-xl text-gray-400 m-10'>Your Search Results</div>
                <div className='m-5'>
                    <Table hoverable >
                        <Table.Head>
                        ...
                        <Table.Body className="divide-y">
                            ...
                            <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                                ...
                                <Table.Cell><Button color="success"> Resolved </Button></Table.Cell>
                            </Table.Row>
                            <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
